...
# Generated by qmake (2.01a) (Qt 4.5.0) on: Mon Jul 27 20:25:32 2009
...
SOURCES       = main.cpp \
		...
		games/tail/tail.cpp moc_mainwindow.cpp \
		moc_world.cpp \
		moc_canvas.cpp \
		moc_startupdlg.cpp \
		moc_force.cpp \
