...
# Generated by qmake (2.01a) (Qt 4.5.0) on: Sun Aug 23 18:04:45 2009
...
SOURCES       = main.cpp \
		...
		games/jelly/jellyactor.cpp moc_mainwindow.cpp \
		moc_world.cpp \
		moc_canvas.cpp \
		moc_startupdlg.cpp \
		moc_force.cpp \
...
moc_tail.cpp: igame.h \
		...
		actorjoint.h \
		games/tail/tail.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) games/tail/tail.h -o moc_tail.cpp
